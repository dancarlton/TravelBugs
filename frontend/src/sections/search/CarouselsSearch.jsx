...
const CarouselsHome = () => {
  ...
  return (
    <div className='flex flex-col relative w-full z-10 mt-20  mb-96'>
      <div className='stars-background absolute top-0 left-0 right-0 '>
      ...
      {questTypes.slice(0, 5).map(type => {
        ...
        return (
          <div key={type.id} className='ml-4 md:ml-10 lg:ml-12 mb-8 z-20'>
