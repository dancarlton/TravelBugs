...
const ExplorerExperiences = () => {
  ...
  return (
    <section className='bg-white py-16 pl-8 lg:pl-32 flex flex-col justify-between'>
      <div className='flex flex-row'>
        <h1 className='text-3xl lg:text-[48px] text-black font-title mr-6 font-thin mb-6'>
