...
const QuestContents = () => {
  return (
    <section className='bg-white lg:py-24 px-6 lg:px-32  flex flex-col lg:flex-row justify-between items-center'>
      {/* Quest Descriptions */}
      <div className='flex flex-col text-4xl lg:text-[48px] text-black font-title gap-y-16 my-4 mr-6'>
        <h1 className='hidden lg:block'>Rewards</h1>
        <h1>Itinerary</h1>
        <h1 className='hidden lg:block'>Planning</h1>
        <h1 className='hidden lg:block'>Recommend</h1>
        <h1 className='hidden lg:block'>Directions</h1>
      </div>

      {/* Itinerary  */}
      <div className='flex flex-col text-black font-secondary lg:w-8/12 lg:text-[18px]'>
        <h3 className='lg:px-4 mb-4'>
        ...
        <div className='collapse collapse-arrow bg-transparent '>
          ...
          <div className='collapse-content  flex flex-col lg:flex-row justify-between'>
            ...
            <img
              src={stockImage}
              alt='Shaman Dude'
              className='rounded-md h-72 w-72 mr-8'
            />
          </div>
          <div className='border-t border-neutral-200'></div>
        </div>
